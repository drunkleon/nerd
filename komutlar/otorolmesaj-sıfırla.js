...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:hypesquad1:763723597863714857>**Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<a:hypesquad1:763723597863714857>  **Ayarlanmamış bir özellik sıfırlanamaz! :wink: **`)
 
 
  message.channel.send(`<a:hypesquad1:763723597863714857>  **Otorol mesajı başarılı bir şekilde sıfırlandı.**`)
