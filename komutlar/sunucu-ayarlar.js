...
const sayfa = [`**${message.guild.name} | Sunucu Ayarları**\n**Botun Prefixi :** \`${p}\n**Reklam Engel:** ${db.fetch(`reklamengel_${message.guild.id}`) ? `:green_circle:` : `<:dnd:763747267671883806>` }\n**Küfür Engel:** ${db.fetch(`kufurE_${message.guild.id}`) ? `:green_circle: ` : `<:dnd:763747267671883806>` }`] 
