...
.setDescription(`<a:hypesquad1:763723597863714857>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setTitle("DLive | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:hypesquad1:763723597863714857>  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
